  ...
  return (
    <Container>
      <span style={{ marginLeft: "32px" }}>
        Общий прогресс: {formatNumber(percentageProgress)}%
      </span>
      <Tooltip
        title={`Выполнил ${userProfile.achievements.length} из ${achievementsCount} достижений`}
      >
        <Progress
            ...
            <TextWrapper>
              ...
              <Description>
                ...
                {achievement.reward && (
                  <>
                    <br />
                    <b> Награда: 🍯{achievement.reward}</b>
                  </>
                )}
              </Description>
            </TextWrapper>
      ...
      {lockedAchievementsCount !== 0 && (
        <Locked>🔒 Заблокированные достижения: {lockedAchievementsCount}</Locked>
      )}
    </Container>
  );
};
