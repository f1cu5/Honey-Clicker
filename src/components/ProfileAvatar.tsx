...
export const ProfileAvatar = ({
  ...
  return (
    <>
      ...
      >
        <Tooltip
          title={userProfile.name !== null ? userProfile.name : "Аноним"}
            ...
            >
              <Avatar
                ...
                onError={() => {
                  ...
                  toast.error(
                    "Не удалось загрузить изображение профиля. Пожалуйста, проверьте правильность URL-адреса изображения."
                  );
                }}
                style={{
                  width: "60px",
      ...
      >
        ...
        >
          <span> Достижения пользователя {userProfile.name} </span>
          <IconButton
