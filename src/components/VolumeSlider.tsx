...
export const VolumeSlider = ({
  ...
  const handleSliderChange = (e: Event, value: number | number[]) => {
    ...
    if (!userProfile.achievements.includes(volumeAchievement.name)) {
      ...
      showToast({
        header: `${volumeAchievement.name} разблокировано!`,
  ...
  return (
    <Stack
      ...
      alignItems="center"
    >
      <Tooltip title={userProfile.audioVolume === 0 ? "Включить звук" : "Выключить звук"}>
